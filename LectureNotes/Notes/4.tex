...
% By greedy algorithm, if the start time is the same, we can do those with sooner ddl first. If this method has no solution, then there's no answer.
...
The algorithm is \textbf{2-approximation}.
